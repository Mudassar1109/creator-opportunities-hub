    ...
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      ...
      <section className="mb-6 sm:mb-8">
        ...
        {hasNoApplications ? (
          <div className="rounded-2xl border border-dashed border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-8 sm:p-12 text-center">
            ...
            <Link href="/opportunities" className="mt-4 inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-purple-600 to-cyan-500 px-5 py-2.5 text-sm font-bold text-white shadow-md shadow-purple-500/20 transition-all hover:shadow-lg hover:-translate-y-0.5">
      ...
      <section className="pb-8">
        ...
        <div className="grid gap-3 sm:gap-4 sm:grid-cols-3">
          {[
            { title: "Browse Opportunities", desc: "Find brand deals, sponsorships, and creator jobs", href: "/opportunities", from: "from-purple-600", to: "to-cyan-500" },
            ...
            { title: "View Applications", desc: "Track the status of your applications", href: "/dashboard/applications", from: "from-cyan-600", to: "to-cyan-400" },
          ].map((action) => (
            <Link
              key={action.title}
              href={action.href}
