    ...
    <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
      ...
      {history.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12 px-6">
          ...
          <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">No referrals yet</p>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 text-center max-w-xs">
            Share your referral link with friends and earn XP when they join CreatorHub.
          </p>
        </div>
      ) : (
