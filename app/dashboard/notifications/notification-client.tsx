  ...
  return (
    ...
    >
      <div className="flex gap-3 min-w-0 flex-1">
        <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${typeColors[notification.type] || "bg-gray-100 dark:bg-gray-800 text-gray-600"}`}>
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 flex-wrap">
            <h3 className={`text-sm font-bold ${!notification.is_read ? "text-gray-900 dark:text-gray-100" : "text-gray-700 dark:text-gray-300"}`}>
              {notification.title}
            </h3>
